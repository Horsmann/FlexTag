...
public class BrownClusterTest
{
    ...
    public void testFirstToken()
        throws Exception
    {
        BrownCluster brownClusterFeature = FeatureUtil.createResource(BrownCluster.class,
                BrownCluster.PARAM_BROWN_CLUSTER_CLASS_PROPABILITIES,
                "src/test/resources/dummyBrownCluster.txt.gz",
                BrownCluster.PARAM_BROWN_CLUSTER_NORMALIZATION, "true",
                BrownCluster.PARAM_LOWER_CASE, "true");

        List<Feature> extract = new ArrayList<Feature>(brownClusterFeature.extract(jcas, tokOne));
        ...
        throws Exception
    {
        BrownCluster brownClusterFeature = FeatureUtil.createResource(BrownCluster.class,
                BrownCluster.PARAM_BROWN_CLUSTER_CLASS_PROPABILITIES,
                "src/test/resources/dummyBrownCluster.txt",
                BrownCluster.PARAM_BROWN_CLUSTER_NORMALIZATION, "true",
                BrownCluster.PARAM_LOWER_CASE, "true");
        ...
        throws Exception
    {
        ...
        List<Feature> extract = new ArrayList<Feature>(brownClusterFeature.extract(jcas, tokTwo));
        assertEquals(8, extract.size());
        ...
        throws Exception
    {
        BrownCluster brownClusterFeature = FeatureUtil.createResource(BrownCluster.class,
                BrownCluster.PARAM_BROWN_CLUSTER_CLASS_PROPABILITIES,
                "src/test/resources/dummyBrownCluster.txt.gz",
                BrownCluster.PARAM_BROWN_CLUSTER_NORMALIZATION, "false",
                BrownCluster.PARAM_LOWER_CASE, "true");
        ...
        throws Exception
    {
        BrownCluster brownClusterFeature = FeatureUtil.createResource(BrownCluster.class,
                ...
                "src/test/resources/dummyBrownCluster.txt.gz",
                BrownCluster.PARAM_BROWN_CLUSTER_NORMALIZATION, "true",
                BrownCluster.PARAM_LOWER_CASE, "false");
