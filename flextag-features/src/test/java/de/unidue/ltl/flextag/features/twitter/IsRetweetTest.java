...
public class IsRetweetTest
{
    ...
    public void testFirstToken()
        throws Exception
    {
        IsRetweet featureExtractor = FeatureUtil.createResource(TcFeatureFactory.create(IsRetweet.class));
        ...
        assertEquals(IsRetweet.FEATURE_NAME, featureName);
