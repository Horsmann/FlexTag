...
{
    public static final String BROWN_CLUSTER = "src/main/resources/res/Owoputi2012_50m.txt";
    public static final String WORD_EMBEDDINGS = "src/main/resources/res/englishDummyEmbedding.txt.gz";
