    ...
    implements Constants
{
        ...
        throws Exception
    {
        ...
        for (TaskContextMetadata subcontext : getSubtasks()) {
            ...
            for (List<String> s : foldersOfSingleRuns) {
                ...
                File test = buildFileLocation(store, testContext,
                        TEST_TASK_OUTPUT_KEY + "/" + featureFile);
                ...
                evaluate(trainVocab, testVocab, pred, inVocab, outVocab, inVocabCount,
                        outVocabCount);
            }
    ...
    private int averageInt(List<Integer> data)
    {
        double avg=0;
        for(Integer i : data){
            avg+=i;
    ...
    private double averageDouble(List<Double> data)
    {
        double avg = 0;
        for (Double d : data) {
            avg += d;
